$argsCheck[>3;( <:errado:1292312941030277200> ) - <@$authorID>, você não digitou todos os argumentos `$getServerVar[prefix]coinflip <valor> <cara ou coroa>`]
...
$onlyIf[$message[1]>0;( <:errado:1292312941030277200> ) - <@$authorID>, você não pode apostar numeros abaixo de 0!]
